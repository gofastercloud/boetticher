...
| [Pulse Community](https://github.com/rcourtman/Pulse/tree/v6.1.2) | Richard Courtman and Pulse contributors | [MIT](https://github.com/rcourtman/Pulse/blob/v6.1.2/LICENSE) | Core API-only Proxmox inventory, metrics, alerts, and availability checks |
