...
//
//go:embed buildbundle.go go.mod go.sum cmd/artifact-identity cmd/boetticher-firewall-telemetry cmd/qualify-artifact cmd/render-blocky-config internal/artifacts internal/dns internal/firewall internal/firewalltelemetry internal/logging internal/model internal/modules images scripts/build-images.sh scripts/scan-images.sh scripts/smoke-appliance.sh scripts/smoke-firewall-image.sh
var FS embed.FS
