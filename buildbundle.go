...
//
//go:embed buildbundle.go go.mod go.sum cmd/artifact-identity cmd/qualify-artifact cmd/render-blocky-config internal/artifacts internal/dns internal/logging internal/model internal/modules internal/usbexport images services/streamdeck scripts/build-images.sh scripts/scan-images.sh scripts/smoke-appliance.sh scripts/smoke-firewall-image.sh
var FS embed.FS
