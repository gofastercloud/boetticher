...
//
//go:embed buildbundle.go go.mod go.sum cmd/artifact-identity cmd/boetticher-aiops cmd/qualify-artifact cmd/render-blocky-config internal/aiops internal/artifacts internal/dns internal/logging internal/model internal/modules images scripts/build-images.sh scripts/scan-images.sh scripts/smoke-appliance.sh scripts/smoke-firewall-image.sh
var FS embed.FS
