...
image-base image-dns-blocky image-dns-adguard image-logging image-monitoring image-firewall image-portal image-tailnet-router image-litellm image-printer images:
	./scripts/build-images.sh $@

scan-base scan-dns-blocky scan-dns-adguard scan-logging scan-monitoring scan-firewall scan-portal scan-tailnet-router scan-litellm scan-printer scan-images:
