...
image-base image-dns-blocky image-logging image-monitoring image-firewall image-portal image-tailnet-router image-airvpn image-litellm image-printer image-arr image-streamdeck image-aiops image-gatus image-network-probe images:
	./scripts/build-images.sh $@

scan-base scan-dns-blocky scan-logging scan-monitoring scan-firewall scan-portal scan-tailnet-router scan-airvpn scan-litellm scan-printer scan-arr scan-streamdeck scan-aiops scan-gatus scan-network-probe scan-images:
