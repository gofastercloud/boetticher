...
The model revision is a SHA-256 digest rendered as `sha256:<hex>`. It is included in generated model, inventory, OPNsense, Proxmox, storage, Zabbix, Ansible, SSH, portal, and verification artifacts. Timestamps and live verification evidence are intentionally excluded from the digest.
