...
| --- | ---: | ---: |
| Controller source LOC | 45,629 | 43,674 |
| Controller test LOC | 23,065 | 22,689 |
| Compiled repository packages | 49 | 50 |
| Controller dependency closure | 1,140 | 1,139 |
| Release controller size, local trust-data build | 53,899,362 bytes | 53,798,418 bytes |
...
| Repository lines changed from baseline | — | 5,237 added / 6,994 deleted / -1,757 net |
...
| Lines added in `origin/0.5.0...HEAD` | — | 5,237 |
| Lines deleted in `origin/0.5.0...HEAD` | — | 6,994 |
| Net repository change | — | -1,757 |
