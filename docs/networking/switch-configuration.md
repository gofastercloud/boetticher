...
trunk. Allow VLANs 5, 10, 20, 30, 40, and 99. Use access ports for ordinary physical
...
In managed gateway mode, Proxmox tags the firewall VM's six zone vNICs. In
external mode, the physical trunk carries the six VLANs to the operator-owned
