...
DNS and NTP remain dual-host services. Blocky is the client-facing
...
DHCP/DDNS. TRANSIT, INFRA, and MGMT use static assignments. Blocky serves the fixed DNS/NTP
