...
default_scan_names="boetticher-base boetticher-dns-blocky boetticher-firewall boetticher-tailnet-router boetticher-airvpn boetticher-network-probe"
case "$target" in
...
for name in $names; do
  case "$name" in
	    boetticher-base|boetticher-dns-blocky|boetticher-logging|boetticher-monitoring|boetticher-firewall|boetticher-tailnet-router|boetticher-airvpn|boetticher-bifrost|boetticher-aiops|boetticher-gatus|boetticher-network-probe) ;;
