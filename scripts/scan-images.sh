...
default_scan_names="boetticher-base boetticher-dns-blocky boetticher-logging boetticher-monitoring boetticher-firewall boetticher-portal boetticher-tailnet-router boetticher-litellm boetticher-printer"
case "$target" in
...
for name in $names; do
  case "$name" in
    boetticher-base|boetticher-dns-blocky|boetticher-dns-adguard|boetticher-logging|boetticher-monitoring|boetticher-firewall|boetticher-portal|boetticher-tailnet-router|boetticher-litellm|boetticher-printer) ;;
