...
default_scan_names="boetticher-base boetticher-dns-blocky boetticher-firewall boetticher-tailnet-router boetticher-airvpn boetticher-arr boetticher-network-probe"
case "$target" in
...
for name in $names; do
  case "$name" in
	    boetticher-base|boetticher-dns-blocky|boetticher-firewall|boetticher-tailnet-router|boetticher-airvpn|boetticher-arr|boetticher-network-probe) ;;
