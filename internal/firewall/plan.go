...
func RenderNFT(plan Plan) (string, error) {
	...
	b.WriteString("flush table inet " + FilterTable + "\n")
	b.WriteString("flush table ip " + NATTable + "\n\n")
	...
	b.WriteString("table ip " + NATTable + " {\n  chain postrouting {\n    type nat hook postrouting priority srcnat; policy accept;\n    oifname \"wan0\" ip saddr @trusted_net masquerade\n    oifname \"wan0\" ip saddr @servers_net masquerade\n    oifname \"wan0\" ip saddr @sandbox_net masquerade\n    oifname \"wan0\" ip saddr @mgmt_net masquerade\n  }\n}\n")
	return b.String(), nil
}
