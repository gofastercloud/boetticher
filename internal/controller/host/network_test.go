...
func TestAdoptionCommandAndBootHook(t *testing.T) {
	...
	if string(data) == original || !strings.Contains(string(data), "iface vmbr1.99 inet static") || !strings.Contains(string(data), "via 10.10.99.1 dev vmbr1.99") || !strings.Contains(string(data), "address 192.168.4.5/24") || strings.Contains(command, "default via") {
