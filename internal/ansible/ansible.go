...
func Inventory(s model.Site) (string, error) {
	...
	groups := map[string][]model.Component{
		"dns": {}, "monitor": {}, "logging": {},
		"tailnet-router": {}, "airvpn": {}, "bifrost": {}, "arr": {}, "aiops": {}, "gatus": {},
	}
	...
	for _, component := range components {
		...
		case "tailnet-router", "airvpn", "bifrost", "arr", "aiops", "gatus":
	...
	for _, group := range []string{"dns", "monitor", "logging", "tailnet-router", "airvpn", "bifrost", "arr", "aiops"} {
