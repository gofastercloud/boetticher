...
func TestRouterBrokerOverwritesModelAndOutputBudget(t *testing.T) {
	...
	broker := &Broker{Capabilities: registry, Evidence: fixedEvidence{}, Router: NewBoundedHTTPClient(router), RouterURL: "https://router.example/v1/chat/completions", ModelAlias: "operations-investigator", Now: func() time.Time { return now }}
