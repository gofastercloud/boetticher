...
// module guests that need a Proxmox MAC-filter boundary. The VMID is encoded in
// the final two octets, keeping these identities separate from gateway and
// upstream NIC reservations without adding another persisted desired-state
// field.
