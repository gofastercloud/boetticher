...
func composeComponents(base []model.Component, resolved []ResolvedModule) []model.Component {
	...
	for _, module := range resolved {
		...
		for _, component := range module.Definition.Components {
			...
			component.Tags = append(component.Tags, model.TagBoetticher, model.TagManaged, model.TagModule, "module-"+module.Definition.Name, "boetticher-module-"+module.Definition.Name, model.TagBackup)
