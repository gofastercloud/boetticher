...
var helpSpecs = map[string]helpSpec{
	...
	"module dhcp test":               {Usage: "boetticher module dhcp test [--plan|--yes]", Purpose: "Run bounded real-client DHCP allocation, naming, and NTP checks.", Arguments: "No positional arguments.", Options: "--plan is read-only; --yes approves the bounded test.", Safety: "Temporary namespaces/veths are independently cleaned; Host root networking and clock are untouched.", Examples: "boetticher module dhcp test --plan; boetticher module dhcp test --yes", Related: "module dhcp status"},
	...
	"module dns test":                {Usage: "boetticher module dns test [--plan|--yes]", Purpose: "Run bounded local-record and encrypted recursive-resolution checks.", Arguments: "No positional arguments.", Options: "--plan is read-only; --yes approves the bounded test.", Safety: "Temporary client fixtures are independently cleaned and TLS verification remains enabled.", Examples: "boetticher module dns test --plan; boetticher module dns test --yes", Related: "module dns status"},
