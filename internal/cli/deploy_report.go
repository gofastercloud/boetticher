...
func deploymentFailureComponent(err error) string {
	...
	for _, component := range []string{"airvpn", "tailnet-router", "monitoring", "bifrost", "aiops", "gatus", "printer", "dns", "logging", "managed gateway", "firewall", "proxmox", "storage", "network", "credentials", "pki"} {
