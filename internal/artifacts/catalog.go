...
func Definitions() []Definition {
	return []Definition{
		...
		{Name: "litellm", ArtifactName: "boetticher-litellm", BuildTarget: "image-litellm", ScanTarget: "boetticher-litellm", Version: ModuleVersion, Kind: "lxc", Architecture: Architecture, Base: BaseName, BaseVersion: BaseVersion, Inputs: append(append([]string(nil), commonDefinitionInputs...), "images/litellm", "internal/bifrost", "cmd/boetticher-bifrost", "internal/model", "internal/modules")},
